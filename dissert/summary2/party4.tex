\begin{tikzpicture}[thick,scale=0.5]
	...
	% the nodes
	\draw (a1) node[lblvertex3, draw = orange] {a};
	\draw (a2) node[lblvertex3, draw = red] {b};
	\draw (a3) node[lblvertex3, draw = blue] {c};
	\draw (a4) node[lblvertex3, draw = yellow] {d};
	\draw (a5) node[lblvertex3, draw = brown] {e};
	\draw (a6) node[lblvertex3, draw = green] {f};
	\draw (a7) node[lblvertex3, draw = purple] {g};
	\draw (a8) node[lblvertex3, draw = yellow] {h};
	\draw (a9) node[lblvertex3, draw = purple] {i};
	\draw (a10) node[lblvertex3, draw = green] {j};
	\draw (a11) node[lblvertex3, draw = black!25] {k};
	\draw (a12) node[lblvertex3, draw = purple] {l};
	\draw (a13) node[lblvertex3, draw = black!25] {m};
	\draw (a14) node[lblvertex3, draw = brown] {n};
	\draw (a15) node[lblvertex3, draw = purple] {o};
	\draw (a16) node[lblvertex3, draw = orange] {p};
