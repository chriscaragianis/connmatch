...
\begin{document}
\bthm{A graph $G$ with $n$ vertices $(v_1, v_2, \ldots, v_n)$ is the distance 2 graph of some claw free graph $H$ if and only if some set of $n$ triangle free induced subgraphs of $G$ whose union is $G$ can be labeled $S_1, S_2, \ldots, S_n$ so that
\begin{enumerate}
	\item $v_i \in V(C_i)$ 
