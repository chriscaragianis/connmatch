...
int main (int argc, char *argv[]) {
	...
	G.insert(e_15);
	char t = *argv[1]; 
	if (t == '1')	IO<DenseGRAPH>::show(G);	
	if (t == '2')	IO<DenseGRAPH>::showAdjMat(G);
	if (t == '3')	Polytope<DenseGRAPH>::printVertexCondition(G);
	if (t == '4')	Polytope<DenseGRAPH>::printEdgePairCondition(G);
	if (t == '5')	Polytope<DenseGRAPH>::printGLPConditions(G);
	if (t == '6')	Polytope<DenseGRAPH>::printEdgeList(G);
	vector <Edge> b = edges(G);
